...
##get vars from new smaple   
   ...
   ###======================year 2013========================##
   smp.fee.13<-get.vars(smp.names,"y13",vars)
   save(smp.fee.13,file="./proc/smp_fee_13.rdata")
...
###==============================year 2015 按病种付费=========================##
   ...
   smp.maincode.fee.15$x3<-hos_names_15[smp.maincode.fee.15$x2] ##change hosnames
   ...
   ###============================load part==============================##
   load("./rdata/var_list.rdata")
   #load("./rdata/smp_names.rdata")
   load("./rdata/smp_names_utf8.rdata")
   load("./rdata/hos_names_14.rdata")
   load("./rdata/hos_names_15.rdata")
   var.list<-read.csv("./rdata/var_list_gbk.csv")
   load("./rdata/var_list.rdata")
   load("./rdata/smp_fee_14.rdata") ##from cledata2,raw data
   load("./rdata/complete_smp_fee_14_2.rdata") ##wide data of smp.14
   load("./rdata/melt_smp_14.rdata") # melt data by hos,exclude NAs 
   load("./rdata/smp_fee_15.rdata") ##from cledata2,raw data
   load("./rdata/complete_smp_fee_15_2.rdata") ##wide data of smp.15
   load("./rdata/melt_smp_15.rdata") # melt data by hos,exclude NAs
